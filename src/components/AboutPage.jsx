    ...
    <div style={{ minHeight: '100vh', background: '#f4f7f7', fontFamily: "'Segoe UI', sans-serif", direction: 'rtl' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '2rem', marginBottom: '2rem', boxShadow: '0 4px 15px rgba(0,0,0,0.08)' }}>
          <h2 style={{ color: '#17324a', marginBottom: '1rem' }}>👋 מי אנחנו?</h2>
          <p style={{ color: '#607482', lineHeight: 1.8, fontSize: '1.05rem' }}>
        ...
        {/* היתרונות */}
        <div style={{ background: 'white', borderRadius: '16px', padding: '2rem', marginBottom: '2rem', boxShadow: '0 4px 15px rgba(0,0,0,0.08)' }}>
          <h2 style={{ color: '#17324a', marginBottom: '1.5rem' }}>✨ למה BonApp?</h2>
          <div style={{ display: 'grid', gap: '1rem' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', background: '#f4f7f7', borderRadius: '8px' }}>
                <span style={{ fontSize: '2rem' }}>{item.icon}</span>
                <div>
                  <div style={{ fontWeight: '600', color: '#17324a' }}>{item.title}</div>
                  <div style={{ color: '#607482', fontSize: '0.9rem' }}>{item.desc}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '2rem', boxShadow: '0 4px 15px rgba(0,0,0,0.08)' }}>
          <h2 style={{ color: '#17324a', marginBottom: '1rem' }}>🛠️ הטכנולוגיה</h2>
          <p style={{ color: '#607482', lineHeight: 1.8 }}>
          ...
          <p style={{ color: '#607482', lineHeight: 1.8, marginTop: '1rem' }}>
            פותח על ידי <strong>Innosys</strong> | <a href="mailto:support@bonapp.dev" style={{ color: '#356b8c' }}>support@bonapp.dev</a>
          </p>
        </div>
