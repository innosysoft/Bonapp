  ...
  const handleSubmit = async () => {
    ...
    try {
      await fetch('https://api.bonapp.dev/api/school-contact', {
        ...
        body: JSON.stringify({
          school_name: 'הצעה לשיפור',
          contact_name: suggestion.name || 'אנונימי',
          contact_email: suggestion.email || 'לא צוין',
          contact_phone: '',
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '2rem', marginBottom: '2rem', boxShadow: '0 4px 15px rgba(0,0,0,0.08)' }}>
          ...
          <div style={{ display: 'grid', gap: '1rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', background: '#f8f9fa', borderRadius: '8px' }}>
              ...
              <div>
                <div style={{ fontWeight: '600', color: '#333' }}>מייל</div>
                <div style={{ color: '#667eea' }}>support@bonapp.dev</div>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', background: '#f8f9fa', borderRadius: '8px' }}>
              <span style={{ fontSize: '1.5rem' }}>⏰</span>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '2rem', boxShadow: '0 4px 15px rgba(0,0,0,0.08)' }}>
          ...
          <p style={{ color: '#666', marginBottom: '1.5rem' }}>
            רעיונות והצעות לשיפור יתקבלו בברכה! אנחנו מקשיבים לכם ומשפרים את המערכת בהתאם.
          </p>
          ...
          {sent ? (
            <div style={{ textAlign: 'center', padding: '2rem', color: '#4CAF50' }}>
              ...
              <h3>תודה על ההצעה!</h3>
              <p>נשמח לשמוע עוד רעיונות בעתיד.</p>
            </div>
          ) : (
            <div style={{ display: 'grid', gap: '1rem' }}>
              <input
              ...
              />
              <textarea
                placeholder="ספרו לנו את הרעיון שלכם..."
